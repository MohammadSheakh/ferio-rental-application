    ...
    <aside className="w-64 border-r border-[#e8e8ea] bg-white flex flex-col justify-between h-screen sticky top-0">
      <div>
        ...
        <div className="p-5 border-b border-[#e8e8ea]">
          ...
          {/* Org Dropdown */}
          <div className="flex items-center justify-between p-2.5 rounded-lg border border-[#e8e8ea] bg-[#fafafa] text-xs font-medium cursor-pointer hover:bg-slate-100 transition-colors">
            <div className="flex items-center gap-2 overflow-hidden">
              <Building className="w-4 h-4 text-[#6e6e73] shrink-0" />
              <span className="truncate text-[#111114] font-medium">Dhaka Prime Properties</span>
            </div>
